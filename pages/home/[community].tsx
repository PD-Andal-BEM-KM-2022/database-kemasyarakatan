...
export default function Community() {
  ...
  return (
    <div className="px-12 py-10 lg:my-24 lg:mx-36">
          ...
          <div className="flex flex-col gap-2 items-start mt-4">
            ...
            {data.contact.email ? (
              <div className="flex gap-3 font-bold items-center justify-center">
                ...
                <p className="lg:text-xl">{data.contact.email}</p>
              </div>
            ) : null}
            ...
            {data.contact.facebook ? (
              <div className="flex gap-3 font-bold items-center justify-center">
                ...
                <p className="lg:text-xl">{data.contact.facebook}</p>
              </div>
            ) : null}
            {/*Instagram */}
            ...
            {data.contact.twitter ? (
              <div className="flex gap-3 font-bold items-center justify-center">
                ...
                <p className="lg:text-xl">{data.contact.twitter}</p>
              </div>
            ) : null}
          </div>
      ...
      {/* Contents */}
      <p className="mt-6 tracking-wide lg:text-xl">
