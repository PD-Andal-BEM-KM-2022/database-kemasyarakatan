        ...
        <div className="w-full h-[100vh] overflow-y-hidden flex flex-row">
            ...
            <div className="flex-col bg-gray-200 w-full h-full rounded-l-md p-14 overflow-y-auto">
                  <div className="flex justify-between pb-9">
                     ...
                     <div onClick={() => {setIsOpen("block")}} className="rounded-lg bg-gray-300 inline-flex items-center px-3 py-2 text-center transition-all hover:shadow-[1px_1px_1px_grey] gap-4">
                        < GrAdd />
                           Create Post
                      </div>
                    </div>
                            ...
                            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                ...
                                <div className="mt-2">
                                    <p className="text-sm text-gray-500">
                                        <input type="text" className="w-full px-3 py-2 text-base text-gray-700 placeholder-gray-600 border rounded-lg focus:shadow-outline" placeholder="Judul Post" />
                                    </p>
                                </div>
                                <div className="mt-2">
                                    <p className="text-sm text-gray-500">
                                        <input type="text" className="w-full px-3 py-2 text-base text-gray-700 placeholder-gray-600 border rounded-lg focus:shadow-outline" placeholder="Date" />
                                    </p>
                                </div>
                                <div className="mt-2">
                                    <p className="text-sm text-gray-500">
                                        <input type="text" className="w-full px-3 py-2 text-base text-gray-700 placeholder-gray-600 border rounded-lg focus:shadow-outline" placeholder="Kategori" />
                                    </p>
                                </div>
                                <div className="mt-2">
                                    <p className="text-sm text-gray-500">
                                        <textarea className="w-full h-[200px] px-3 py-2 text-base text-gray-700 placeholder-gray-600 border rounded-lg focus:shadow-outline" placeholder="Deskripsi"  />
                                    </p>
                                </div>
                            </div>
                        </div>
