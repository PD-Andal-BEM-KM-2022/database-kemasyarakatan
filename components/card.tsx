            ...
            <>
                ...
                <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 transition-all hover:shadow-[1px_8px_20px_grey]">
                    ...
                    <div className="p-5 flex flex-col justify-between">
                        ...
                        <p className="desc mb-3 font-normal text-gray-700 text-justify dark:text-gray-400 min-h-[100px]">{text}</p>
                        <button type="button"
                            onClick={() => {
                                Router.push({
                                  pathname: '/[id]',
                            ...
                            className="w-[37.5%] inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Read more
